...
class _BotCommands:
    def __init__(self):
        ...
        self.ListCommand = f'cari{CMD_INDEX}'
        ...
        self.KangCommand = f'curry{CMD_INDEX}'
        self.StickeridCommand = f'stickerid{CMD_INDEX}'
        self.GetstickerCommand = f'getsticker{CMD_INDEX}'
        self.StickersCommand = f'stickers{CMD_INDEX}'
