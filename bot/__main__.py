...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror, clone, watch, shell, eval, delete, speedtest, count, leech_settings, search, rss, wyb, mediainfo, shortlink, vscan, stats, hash, sticker,antispam
    ...
    if ospath.isfile(".restartmsg"):
        ...
        try:
            for i in AUTHORIZED_CHATS:
                if str(i).startswith('-'):
                    bot.sendMessage(chat_id=i, text="<b>Over Modular Online!</b>", parse_mode=ParseMode.HTML)
